...
def run(args):
    ...
    if args.plot or args.save_plot or args.serialize_plot:
        ...
        if SETTINGS.plot_statistics:
            ...
            if any(include):
                ...
                # df.loc["stats"][include].plot(kind="barh", ax=axarr[0,1],
                                              # colormap=colormap, stacked=False)
                plt.savefig("/home/kostas/report/figures/appendix_stats/"+name+"_statistics.png",
                        dpi = 300, format='png', bbox_inches='tight')
        ...
        plt.savefig("/home/kostas/report/figures/appendix_stats/"+name+"_distributions.png",
                dpi = 300, format='png', bbox_inches='tight')
